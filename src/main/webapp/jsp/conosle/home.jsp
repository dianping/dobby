...
<jsp:useBean id="ctx" type="com.dianping.dobby.conosle.page.home.Context" scope="request"/>
<jsp:useBean id="payload" type="com.dianping.dobby.conosle.page.home.Payload" scope="request"/>
<jsp:useBean id="model" type="com.dianping.dobby.conosle.page.home.Model" scope="request"/>
