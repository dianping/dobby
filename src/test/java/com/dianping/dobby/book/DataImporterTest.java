...
public class DataImporterTest {
	...
	public static void main(String[] args) throws Exception {
		List<String> lines = FileUtils.readLines(new File(
		      "/Users/damonzhu/Projects/dobby/src/test/resources/com/dianping/dobby/book/books.txt"));
		...
		List<String> historys = FileUtils.readLines(new File(
		      "/Users/damonzhu/Projects/dobby/src/test/resources/com/dianping/dobby/book/history.txt"));
